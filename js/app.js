...
if (location.hostname === "mws-restaurant-stage-1-webdevjlprojects.c9users.io" || location.hostname ===
    "agitated-shockley-450c4d.netlify.com" || location.hostname === "mws-nd-s1.puzzlout.com") {
    appAlias = "";
}
